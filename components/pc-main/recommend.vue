            ...
            <div v-if="item.showType===1">
              ...
              <div class="content-box">
                ...
                <router-link :to="`/detail/${item.id}`" v-if="item.img" class="lazy thumb thumb loaded">
                  <i :style="{'background-image': 'url('+imgUrl+'news/'+ item.img.split('|')[0]+')'}"></i>
                </router-link>
              ...
              <div class="content-box2">
                ...
                <div  v-if="item.imgArr.length>1&&k<6 " class="lazy loaded2 more-img"
                  ...
                  <div class="detail_img"
                       :style="{'background-image': 'url(https://maoping2.oss-cn-shenzhen.aliyuncs.com/news/'+v.split('|')[0]+')'}"></div>
                </div>
                <div  v-if="item.imgArr.length==1" class="lazy loaded2"
                   v-for="(v,k) in item.imgArr"
                   style="max-width: 100%;height: 8rem;">
                  <img :src="`https://maoping2.oss-cn-shenzhen.aliyuncs.com/news/${v.split('|')[0]}`"/>
                </div>
              </div>
              <!--<Zan :id="item.id" :like="item.like" :choose="item.choose" :type="item.showType"-->
              <!--v-on:increment="incrementTotal"></Zan>-->
