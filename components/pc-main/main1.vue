    ...
    <div class="view timeline-index-view">
      <div class="timeline-entry-list">
        ...
        <div v-if="menuSelected!==4">
          <header class="list-header 555555">
            <nav class="list-nav">
...
<!--           <MenuList></MenuList>
      ...
      <aside class="index-aside aside" style="background:#ffffff;" v-bind:style="asideStyle">
        <Dates></Dates>

        <section class="side_mood">
        <p class="side_title">每日心情</p>
        <nuxt-link to="/douguo"><img :src="everyImg" style="width:80%;margin:0 auto;display:block;"></nuxt-link>
        <div class="clear"></div>
        </section>
...
<script>
  ...
  import Hoted from '~/components/pc-main/hot1'
  ...
  export default {
    ...
    data () {
      return {
        ...
        tagList: {},
        everyImg: 'https://maoping2.oss-cn-shenzhen.aliyuncs.com/news/guoke-2622.jpg',
        pageNum: 10,
        prosId: 0,
        show_time_text: '',
        day: [
    ...
    mounted () {
      // 初始化日期
      this.show_time_text = this.day[new Date().getDay()-1]
      const that = this
      window.onresize = () => {
